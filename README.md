...
- [dev-sec/ansible-os-hardening](https://github.com/dev-sec/ansible-os-hardening) ([7.0.0](https://github.com/dev-sec/ansible-os-hardening/releases/tag/7.0.0), 5 days ago) - This Ansible role provides numerous security-related configurations, providing all-round base protection.
