...
- [dev-sec/ansible-os-hardening](https://github.com/dev-sec/ansible-os-hardening) ([7.0.0](https://github.com/dev-sec/ansible-os-hardening/releases/tag/7.0.0), 3 days ago) - This Ansible role provides numerous security-related configurations, providing all-round base protection.
- [dustinmiller1337/terraform-metal-whirl](https://github.com/dustinmiller1337/terraform-metal-whirl) ([v0.3](https://github.com/dustinmiller1337/terraform-metal-whirl/releases/tag/v0.3), 5 days ago) - Metal, Terraform, Ansible, Docker, Cloudflare, LetsEncrypt, Traefik
