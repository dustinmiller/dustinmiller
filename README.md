...
- [dev-sec/ansible-collection-hardening](https://github.com/dev-sec/ansible-collection-hardening) ([7.0.0](https://github.com/dev-sec/ansible-collection-hardening/releases/tag/7.0.0), 5 days ago) - This Ansible collection provides battle tested hardening for Linux, SSH, nginx, MySQL
