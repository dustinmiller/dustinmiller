...
- [dev-sec/ansible-os-hardening](https://github.com/dev-sec/ansible-os-hardening) ([7.0.0](https://github.com/dev-sec/ansible-os-hardening/releases/tag/7.0.0), 2 days ago) - This Ansible role provides numerous security-related configurations, providing all-round base protection.
- [dustinmiller1337/terraform-metal-whirl](https://github.com/dustinmiller1337/terraform-metal-whirl) ([v0.3](https://github.com/dustinmiller1337/terraform-metal-whirl/releases/tag/v0.3), 4 days ago) - Metal, Terraform, Ansible, Docker, Cloudflare, LetsEncrypt, Traefik
- [dustinmiller1337/docker-racadm](https://github.com/dustinmiller1337/docker-racadm) ([v0.2](https://github.com/dustinmiller1337/docker-racadm/releases/tag/v0.2), 6 days ago) - docker-racadm
