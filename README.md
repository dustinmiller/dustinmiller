...
- [dev-sec/ansible-os-hardening](https://github.com/dev-sec/ansible-os-hardening) ([6.2.0](https://github.com/dev-sec/ansible-os-hardening/releases/tag/6.2.0), 1 day ago) - This Ansible role provides numerous security-related configurations, providing all-round base protection.
